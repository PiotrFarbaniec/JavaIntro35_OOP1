...
public class Main {
    public static void main(String[] args) {
        ...
        BaseEmployee manager = new Manager("manager", "Dariusz", "Kozak",
        ...
        System.out.println("My monthly salary is: " + manager.claculateMonthlySalary());


        BaseEmployee seller = new Seller("ticket seller", "Tadeusz", "Rydzyk",
        ...
        System.out.println("My monthly salary is: " + seller.claculateMonthlySalary());
    }
}